  ...
  const movies = [
    {
      ...
      time: "1h 37m",
      lang: "Hindi",
      desc: "Family emergencies, long-standing feuds, a hysterical crisis hit one morning.",
      genres: "Comedy • Family • Dramedy"
    },
    {
      img: jd2,
      ...
      time: "2h 10m",
      lang: "English",
      desc: "An undercover agent trapped inside enemy territory with no backup.",
    ...
    },
    {
      ...
      time: "1h 55m",
      lang: "Hindi",
      desc: "A relationship tested by secrets that refuse to stay buried.",
    ...
    },
    {
      ...
      time: "2h 05m",
      lang: "English",
      desc: "A hacker vs the world’s most powerful AI defense system.",
    ...
    },
    {
      ...
      time: "1h 48m",
      lang: "Hindi",
      desc: "A family moves into a house where shadows have memories.",
    ...
    },
    {
      ...
      time: "2h 01m",
      lang: "English",
      desc: "A retired racer returns for one final impossible race.",
      genres: "Sports • Drama"
    }
  ];
